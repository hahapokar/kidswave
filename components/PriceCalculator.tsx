...
const PriceCalculator: React.FC<PriceCalculatorProps> = ({ basePrice, addons }) => {
  ...
  return (
    <div className="bg-white border border-gray-100 p-8 rounded-lg shadow-sm">
      <h3 className="text-xl font-medium mb-6 serif-font">价格估算工具</h3>
      
      <div className="space-y-4 mb-8">
        <div className="flex justify-between items-center pb-4 border-bottom border-gray-50">
          <span className="text-gray-500 text-sm">作品基础形式 (A)</span>
      ...
      <div className="pt-6 border-t border-gray-100 flex justify-between items-end">
        <div>
          <p className="text-xs text-gray-400 uppercase tracking-widest mb-1">预计总计 (ESTIMATED TOTAL)</p>
